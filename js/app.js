(function() {
  ...
  var per = document.getElementById('opciones');
  var ver = document.getElementById('estado');
  var im = document.getElementById('portada');
  

  im.addEventListener('click', () => {
    addTodo(per.value, ver.value, im.src);
  });

  // EDITING STARTS HERE (you dont need to edit anything above this line)

  var db = new Pouch('Teen_Wolf');
  ...
  function addTodo(per,ver) {
    ...
    // var noVale = /\s/;
    // if (todo.title === "" || noVale.test(todo.title)) {
    //   console.error('El documento está en blanco o contiene solo espacios.');
    // }
    // else{
